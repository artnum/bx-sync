...
#define bx_database_add_param_varchar(query, name, value, value_len)           \
  bx_database_add_param_str(query, name, value, value_len,                     \
...
#define bxd_bind(st, member)                                                   \
  bx_database_add_bxtype(query, ":" #member, (BXGeneric *)&st->member)
