...
inline static void _bx_dump_integer(const char * key, BXInteger integer, int level)
{
...
inline static void _bx_dump_string(const char * key, BXString string, int level)
{
    _bx_dump_key(key, level);
